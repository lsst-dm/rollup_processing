# This file is part of rollup_processing.
#
...
from helpers import get_day_obs, query_exposures_without_visit_geometry
...
def _run_init(butler_repo, day_obs, init_run, seed_exp_id):
    ...
    day_obs : `str`
        Eight-digit day_obs string (YYYYMMDD), used to select
        input collections.
    init_run : `str`
...
def run_all_visits(butler_repo, exp_ids, output_run, n_processes=4):
    ...
    None
    """
    # Assumes all exp_ids are from the same day_obs.
...
if __name__ == "__main__":
    ...
    parser.add_argument("n_hours", nargs="?", default=1, type=float, help="Number of hours (default: 1)")
